package duebel_level.animation.tween;

import duebel_level.animation.Easings;
import duebel_level.animation.tween.value.Tween2d;
import duebel_level.animation.tween.value.Tween2i;
import duebel_level.animation.tween.value.TweenValue;
